...
import TrainingAlignmentPanel from './TrainingAlignmentPanel.vue'
...
const defaultRegionProfile = {
  name: '地区',
  image: 'https://source.unsplash.com/900x520/?city,industry,china',
...
const regionProfiles = {
  广东: {
    name: '广东',
    image: 'https://source.unsplash.com/900x520/?guangzhou,shenzhen,skyline',
  ...
  北京: {
    name: '北京',
    image: 'https://source.unsplash.com/900x520/?beijing,technology',
  ...
  上海: {
    name: '上海',
    image: 'https://source.unsplash.com/900x520/?shanghai,finance,skyline',
  ...
  浙江: {
    name: '浙江',
    image: 'https://source.unsplash.com/900x520/?hangzhou,digital,economy',
  ...
  江苏: {
    name: '江苏',
    image: 'https://source.unsplash.com/900x520/?nanjing,suzhou,industry',
  ...
  四川: {
    name: '四川',
    image: 'https://source.unsplash.com/900x520/?chengdu,technology',
  ...
  湖北: {
    name: '湖北',
    image: 'https://source.unsplash.com/900x520/?wuhan,university,industry',
  ...
  陕西: {
    name: '陕西',
    image: 'https://source.unsplash.com/900x520/?xian,technology,university',
    ...
    links: [
      ...
      { label: '陕西省教育厅', url: 'http://jyt.shaanxi.gov.cn/' },
        ...
        <div class="region-detail-layout">
          <article class="region-story-card">
            <div class="region-profile-media">
              <img :src="regionProfile.image" :alt="`${regionProfile.name}地区视觉图`" />
              <div>
                <span>地区档案</span>
